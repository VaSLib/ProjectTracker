...
{
    /// <inheritdoc />
    public partial class seconChange : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeEntityProjectEntity_AspNetUsers_EmployeesId",
                        column: x => x.EmployeesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeEntityProjectEntity_ProjectEntities_ProjectsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutorUserName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskEntities_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskEntities_AspNetUsers_ExecutorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskEntities_AuthorId",
                table: "TaskEntities",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskEntities_ExecutorId",
                table: "TaskEntities",
                column: "ExecutorId");
